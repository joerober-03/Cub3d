...
/*   Updated: 2023/08/23 16:05:28 by dferreir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_square(t_var *v, double step_x, double step_y)
{
	...
	new_step_x = step_x * v->map.index_x;
	new_step_y = step_y * v->map.index_y;
	y = new_step_y - 1;
...
void	mini_map_base(t_var *v)
{
	...
	v->map.total_x = v->map.total_x / v->map.map_width * v->map.map_width;
	v->map.total_y = v->map.total_y / v->map.map_height * v->map.map_height;
	y = -1;
